...
3. Print the URL (e.g., `https://example.trycloudflare.com`)
...
- Development (live reload): `https://example.trycloudflare.com/2025-12-14-dashboard/index.html?ws=true`
- Share (static): `https://example.trycloudflare.com/2025-12-14-dashboard/index.html`
...
**Access:** `https://example.trycloudflare.com/2025-12-14-threejs-cube/index.html?ws=true`
