...
assert.equal(
	compileReferences("<a@example.com> <reply1@example.com>", "<b@example.com>"),
	"<a@example.com> <reply1@example.com> <b@example.com>",
);
...
assert.deepEqual(
	buildReplyThreadHeaders("<b@example.com>", "<a@example.com> <reply1@example.com>"),
	{
		in_reply_to: "<b@example.com>",
		references: "<a@example.com> <reply1@example.com> <b@example.com>",
	},
);
