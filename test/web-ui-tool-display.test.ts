...
assert(getToolDetail(sendEmailCall) === "Email user@example.com: Line one Line two with a little more detail", "send_message aliases show destination and collapsed message preview");
