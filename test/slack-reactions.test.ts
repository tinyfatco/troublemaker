...
try {
	...
	await assert.rejects(
		(reactTool.execute as any)("non-slack", { label: "Reject another platform", target: "mattermost:abcdefghijklmnopqrstuvwx12:zyxwvutsrqponmlkjihgfedc21", emoji: "thumbsup" }),
