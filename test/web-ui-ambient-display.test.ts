...
<ambient_messages>
Casey (U0987654321) [Reply target: slack:C0123456789:1700000002.000100; message_ts: 1700000003.000100; thread_ts: 1700000002.000100]: please answer inside this thread
</ambient_messages>
...
assert(currentLines[0] === "Casey: please answer inside this thread", "current ambient display strips routing metadata");
...
assert(getAmbientDisplayLines(bareSteeredAmbient?.strippedText || "")[0] === "Casey: please answer inside this thread", "bare steered ambient rendering retains only the posted message");
