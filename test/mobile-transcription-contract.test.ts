...
try {
	...
	const gateway = new Gateway({ workspaceDir: workspace, transcription: service, consoleEnvironment: {} });
	...
	const restarted = new Gateway({ workspaceDir: workspace, transcription: service, consoleEnvironment: {} });
	...
	const unavailable = new Gateway({ workspaceDir: workspace, consoleEnvironment: {} });
