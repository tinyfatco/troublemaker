...
Use \`self_configure\` when the user explicitly asks you to change your own model, thinking level, verbosity, Slack response placement, Realtime voice, heartbeat/spontaneity, or heartbeat checklist settings.
