...
Use \`yield_no_action\` for heartbeat, ambient, or post-run follow-up evaluations where nothing needs doing and no user-visible response should be posted.`;
