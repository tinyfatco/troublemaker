...
Use \`self_configure\` when the user explicitly asks you to change your own model, thinking level, verbosity, Slack response placement, selective Slack tool streaming, Slack tool-stream presentation (batched or condensed), Slack tool-stream batch size, Realtime voice, heartbeat/spontaneity, or heartbeat checklist settings.
