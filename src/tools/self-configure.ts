...
function resolveWorkingOutputTarget(value: unknown, options: SelfConfigureOptions): WorkingOutputTarget {
	...
	throw new Error("working_output fixed target must be 'here', a Slack C/G/D channel or DM ID, {platform:'mattermost', channelId:'<26-character ID>'}, {platform:'rocket-chat', channelId:'<room ID>'}, or {platform:'zulip', channelId:'<numeric channel ID>'}.");
}
