...
function message(id, from, to, subject, body) {
	return { id, date: "Thu, 23 Jul 2026 12:00:00 +0000", from, to, cc: "", bcc: "", subject, body };
}

function fakeGmail() {
	const threads = new Map([
		["thread-owner", [message("message-owner", "owner@example.com", "agent@example.com", "Owner request", "Hello")]],
