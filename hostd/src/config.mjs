...
export async function loadConfig(path, environment = process.env) {
	...
	return {
		...
		scheduler: {
			...
			relationshipBurstWindowMs: integer(
				scheduler.relationshipBurstWindowMs,
				0,
				"scheduler.relationshipBurstWindowMs",
				0,
				5000,
			),
			relationshipBurstMaximumMessages: integer(
				scheduler.relationshipBurstMaximumMessages,
				10,
				"scheduler.relationshipBurstMaximumMessages",
				2,
				20,
